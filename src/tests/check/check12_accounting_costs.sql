/***************************************************************
**
**  Contrainte : Quand on insert un accounting, les frais
**  doivent être supérieur à 0.
**
**  Objectif : Voir si on peut ajouter des frais inférieur à 0.
**
**  Test :
**    - On insère un accounting avec un frais de 1 000$.
**    - On insère un accounting avec un frais de -100$.
**
***************************************************************/
...
\echo '----------------------------------------------'
\echo ' Insertion accounting avec un costs de 1000\n'
\echo '     - 1000 > 0 : Valide'
\echo '----------------------------------------------\n\n'
...
\echo '----------------------------------------------'
\echo ' Insertion accounting avec un costs de - 100\n'
\echo '     - -100 > 0 : Invalide'
\echo '----------------------------------------------\n\n'

\echo '> INSERT INTO accounting(accounting_id, payment_id, contract_aa_id, amount, costs) VALUES (1001, 1000, 1000, 1000, -100);\n\n'

-- INVALIDE
INSERT INTO accounting(accounting_id, payment_id, contract_aa_id, amount, costs) VALUES (1001, 1000, 1000, 1000, -100);
