...
**  et un artiste, le revenu doit être supérieur à 0.
**
**  Objectif : Voir si on peut ajouter un revenu inférieur à 0.
**
**  Test :
**    - On insère un contrat producer-artiste avec un revenu de
**      2 500.
**    - On insère un contrat producer-artiste avec un revenu de
**      -100.
**
...
\echo ' earning de 25 000 \n'
\echo '     - 25 000 > 0 : Valide'
\echo '----------------------------------------------\n\n'
...
\echo '----------------------------------------------'
\echo ' Insertion contract_producer_artist avec un\n'
\echo ' earning de -25000 \n'
\echo '     - -25000 < 0 : Invalide'
\echo '----------------------------------------------\n\n'

\echo '> INSERT INTO Contract_producer_artist(contract_pa_id, demand_id, artist_id, earning, profit_sharing, start_date_contract_pa, end_date_contract_pa, clause, clause_profit) VALUES (1001, 1000, 1000, -25000, 25, ''2023-05-04'', ''2024-4-1'', 10000000, 300000);\n\n'

-- INVALIDE
INSERT INTO contract_producer_artist(contract_pa_id, demand_id, artist_id, earning, profit_sharing, start_date_contract_pa, end_date_contract_pa, clause, clause_profit) VALUES (1001, 1000, 1000, -25000, 25, '2023-05-04', '2024-4-1', 10000000, 300000);
