...
**  S'il a réusssi l'audition alors on ajoute sa participation
**  au projet.
**
**  Objectif : Verifié la participation d'un artiste
**
**  Test 1 :
...
\! cls
\echo '**********************************************'
\echo ' TEST : trigger fill_participate table\n'
...
\echo '     - result = true \n'
\echo '     - doit ajouter dans participate : Valide '
\echo '----------------------------------------------'
\prompt 'next'
...
\echo '> SELECT * FROM participate WHERE artist_id = 1000;\n'
SELECT * FROM participate WHERE artist_id = 1000;

\prompt 'next'
\echo '----------------------------------------------'
\echo ' Insertion propose \n'
\echo '     - result = false \n'
\echo '     - doit pas ajouter dans participate : Invalide'
\echo '----------------------------------------------'
\prompt 'next'
...
\echo '> SELECT * FROM participate WHERE artist_id = 1000 OR artist_id = 1001;\n'

SELECT * FROM participate WHERE artist_id = 1000 OR artist_id = 1001;
